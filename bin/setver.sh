...
gsed -i  "s/^\( *tau_wars: *#* *\^*\).*$/\1$VERSION/"                                   example/pubspec.yaml
gsed -i  "s/^\( *tau_wars: *#* *\^*\).*$/\1$VERSION/"                                   ../etau/example/pubspec.yaml
gsed -i  "s/^\( *## \).*$/\1$VERSION/"                                                  CHANGELOG.md

gsed -i  "s/^TAU_WARS_VERSION:.*/TAU_WARS_VERSION: $VERSION/"                           ../tau_doc/_config.yml
gsed -i  "s/^\( *version: \).*/\1$VERSION/"                                             ../tau_doc/_data/sidebars/tauwars_sidebar.yml
